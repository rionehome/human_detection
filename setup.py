...
setup(
    ...
    data_files=[
        ...
        ('lib/python3.6/site-packages/human_detection/sample_image',
         ['human_detection/sample_image/not_face.png', 'human_detection/sample_image/not_face2.png',
          'human_detection/sample_image/face.png', 'human_detection/sample_image/face2.png']),
